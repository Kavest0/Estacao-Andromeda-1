...
fax-machine-popup-name-long = Nome do fax muito longo
fax-machine-popup-name-exist = Já existe um fax com o mesmo nome na rede
fax-machine-popup-name-set = Nome do fax atualizado
fax-machine-popup-error = ERRO - atolamento na alimentação de papel
fax-machine-popup-copy-error = ERRO - não foi possível copiar!
...
fax-machine-ui-no-peers = Sem Destinatários
