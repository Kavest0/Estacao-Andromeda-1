...
air-alarm-ui-window-resync-devices-label = Re-sincronizar
...
air-alarm-ui-window-tab-vents = Dutos
...
air-alarm-ui-widget-copy-tooltip = Copia as configurações deste dispositivo para todos os dispositivos nesta aba de alarme atmosférico.
air-alarm-ui-widget-ignore = Ignorar
air-alarm-ui-atmos-net-device-label = Endereço: {$address}

### Bombas de ventilação

air-alarm-ui-vent-pump-label = Direção do duto
...
air-alarm-ui-thresholds-copy-tooltip = Copia os limiares dos sensores deste dispositivo para todos os dispositivos nesta aba de alarme atmosférico.
